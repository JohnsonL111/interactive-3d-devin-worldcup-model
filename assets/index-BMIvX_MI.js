 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(U,Y){var K=U.length;U.push(Y);e:for(;0<K;){var re=K-1>>>1,ye=U[re];if(0<r(ye,Y))U[re]=Y,U[K]=ye,K=re;else break e}}function n(U){return U.length===0?null:U[0]}function i(U){if(U.length===0)return null;var Y=U[0],K=U.pop();if(K!==Y){U[0]=K;e:for(var re=0,ye=U.length,He=ye>>>1;re<He;){var V=2*(re+1)-1,te=U[V],le=V+1,oe=U[le];if(0>r(te,K))le<ye&&0>r(oe,te)?(U[re]=oe,U[le]=K,re=le):(U[re]=te,U[V]=K,re=V);else if(le<ye&&0>r(oe,K))U[re]=oe,U[le]=K,re=le;else break e}}return Y}function r(U,Y){var K=U.sortIndex-Y.sortIndex;return K!==0?K:U.id-Y.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;t.unstable_now=function(){return s.now()}}else{var o=Date,a=o.now();t.unstable_now=function(){return o.now()-a}}var l=[],u=[],f=1,h=null,d=3,p=!1,m=!1,y=!1,g=typeof setTimeout=="function"?setTimeout:null,c=typeof clearTimeout=="function"?clearTimeout:null,v=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function _(U){for(var Y=n(u);Y!==null;){if(Y.callback===null)i(u);else if(Y.startTime<=U)i(u),Y.sortIndex=Y.expirationTime,e(l,Y);else break;Y=n(u)}}function S(U){if(y=!1,_(U),!m)if(n(l)!==null)m=!0,G(R);else{var Y=n(u);Y!==null&&q(S,Y.startTime-U)}}function R(U,Y){m=!1,y&&(y=!1,c(P),P=-1),p=!0;var K=d;try{for(_(Y),h=n(l);h!==null&&(!(h.expirationTime>Y)||U&&!b());){var re=h.callback;if(typeof re=="function"){h.callback=null,d=h.priorityLevel;var ye=re(h.expirationTime<=Y);Y=t.unstable_now(),typeof ye=="function"?h.callback=ye:h===n(l)&&i(l),_(Y)}else i(l);h=n(l)}if(h!==null)var He=!0;else{var V=n(u);V!==null&&q(S,V.startTime-Y),He=!1}return He}finally{h=null,d=K,p=!1}}var A=!1,T=null,P=-1,w=5,x=-1;function b(){return!(t.unstable_now()-x<w)}function H(){if(T!==null){var U=t.unstable_now();x=U;var Y=!0;try{Y=T(!0,U)}finally{Y?k():(A=!1,T=null)}}else A=!1}var k;if(typeof v=="function")k=function(){v(H)};else if(typeof MessageChannel<"u"){var X=new MessageChannel,W=X.port2;X.port1.onmessage=H,k=function(){W.postMessage(null)}}else k=function(){g(H,0)};function G(U){T=U,A||(A=!0,k())}function q(U,Y){P=g(function(){U(t.unstable_now())},Y)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(U){U.callback=null},t.unstable_continueExecution=function(){m||p||(m=!0,G(R))},t.unstable_forceFrameRate=function(U){0>U||125<U?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):w=0<U?Math.floor(1e3/U):5},t.unstable_getCurrentPriorityLevel=function(){return d},t.unstable_getFirstCallbackNode=function(){return n(l)},t.unstable_next=function(U){switch(d){case 1:case 2:case 3:var Y=3;break;default:Y=d}var K=d;d=Y;try{return U()}finally{d=K}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(U,Y){switch(U){case 1:case 2:case 3:case 4:case 5:break;default:U=3}var K=d;d=U;try{return Y()}finally{d=K}},t.unstable_scheduleCallback=function(U,Y,K){var re=t.unstable_now();switch(typeof K=="object"&&K!==null?(K=K.delay,K=typeof K=="number"&&0<K?re+K:re):K=re,U){case 1:var ye=-1;break;case 2:ye=250;break;case 5:ye=1073741823;break;case 4:ye=1e4;break;default:ye=5e3}return ye=K+ye,U={id:f++,callback:Y,priorityLevel:U,startTime:K,expirationTime:ye,sortIndex:-1},K>re?(U.sortIndex=K,e(u,U),n(l)===null&&U===n(u)&&(y?(c(P),P=-1):y=!0,q(S,K-re))):(U.sortIndex=ye,e(l,U),m||p||(m=!0,G(R))),U},t.unstable_shouldYield=b,t.unstable_wrapCallback=function(U){var Y=d;return function(){var K=d;d=Y;try{return U.apply(this,arguments)}finally{d=K}}}})(vm);gm.exports=vm;var Lv=gm.exports;/**
 * @license React
...
`+tw(t.getShaderSource(e),o)}else return r}function iw(t,e){const n=nw(e);return`vec4 ${t}( vec4 value ) { return ${n[0]}( ${n[1]}( value ) ); }`}function rw(t,e){let n;switch(e){case dx:n="Linear";break;case hx:n="Reinhard";break;case px:n="OptimizedCineon";break;case mx:n="ACESFilmic";break;case vx:n="AgX";break;case _x:n="Neutral";break;case gx:n="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),n="Linear"}return"vec3 "+t+"( vec3 color ) { return "+n+"ToneMapping( color ); }"}function sw(t){return[t.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",t.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(ao).join(`
...
#define LOW_PRECISION`),e}function hw(t){let e="SHADOWMAP_TYPE_BASIC";return t.shadowMapType===g0?e="SHADOWMAP_TYPE_PCF":t.shadowMapType===ky?e="SHADOWMAP_TYPE_PCF_SOFT":t.shadowMapType===ai&&(e="SHADOWMAP_TYPE_VSM"),e}function pw(t){let e="ENVMAP_TYPE_CUBE";if(t.envMap)switch(t.envMapMode){case Ps:case bs:e="ENVMAP_TYPE_CUBE";break;case Wl:e="ENVMAP_TYPE_CUBE_UV";break}return e}function mw(t){let e="ENVMAP_MODE_REFLECTION";if(t.envMap)switch(t.envMapMode){case bs:e="ENVMAP_MODE_REFRACTION";break}return e}function gw(t){let e="ENVMAP_BLENDING_NONE";if(t.envMap)switch(t.combine){case v0:e="ENVMAP_BLENDING_MULTIPLY";break;case cx:e="ENVMAP_BLENDING_MIX";break;case fx:e="ENVMAP_BLENDING_ADD";break}return e}function vw(t){const e=t.envMapCubeUVHeight;if(e===null)return null;const n=Math.log2(e)-2,i=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,n),7*16)),texelHeight:i,maxMip:n}}function _w(t,e,n,i){const r=t.getContext(),s=n.defines;let o=n.vertexShader,a=n.fragmentShader;const l=hw(n),u=pw(n),f=mw(n),h=gw(n),d=vw(n),p=sw(n),m=ow(s),y=r.createProgram();let g,c,v=n.glslVersion?"#version "+n.glslVersion+`
...
`)+`
`+c);const _=v+g+o,S=v+c+a,R=kp(r,r.VERTEX_SHADER,_),A=kp(r,r.FRAGMENT_SHADER,S);r.attachShader(y,R),r.attachShader(y,A),n.index0AttributeName!==void 0?r.bindAttribLocation(y,0,n.index0AttributeName):n.morphTargets===!0&&r.bindAttribLocation(y,0,"position"),r.linkProgram(y);function T(b){if(t.debug.checkShaderErrors){const H=r.getProgramInfoLog(y).trim(),k=r.getShaderInfoLog(R).trim(),X=r.getShaderInfoLog(A).trim();let W=!0,G=!0;if(r.getProgramParameter(y,r.LINK_STATUS)===!1)if(W=!1,typeof t.debug.onShaderError=="function")t.debug.onShaderError(r,y,R,A);else{const q=Bp(r,R,"vertex"),U=Bp(r,A,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(y,r.VALIDATE_STATUS)+`
